...
public class FuelLocation_FelidValidation {
	...
	String ExpectedIdErrorMessage = ExcelUtils.getstringCellData(10, 5);
	...
	String ExpectedAddress1ErrorMessage = ExcelUtils.getstringCellData(12, 5);
	...
	String ExpectedCityErrorMessage = ExcelUtils.getstringCellData(13, 5);;
	...
	String ExpectedStateErrorMessage = ExcelUtils.getstringCellData(14, 5);
	...
	String ExpectedZipErrorMessage = ExcelUtils.getstringCellData(15, 5);
	...
	public static WebElement NameFeildVliadation (WebDriver driver) throws Exception{
		...
		NameFeildVliadation.sendKeys(ExcelUtils.getstringCellData(17, 4));
		
		Thread.sleep(3000);

	String	NameErrorMessage =driver.findElement(By.xpath(".//*[@id='BaseFuelingLocation_Text-error']")).getText();
	String ActualElement =  ExcelUtils.getstringCellData(17, 5);
		if(NameErrorMessage.equals( ActualElement))
		{
			...
			NameFeildVliadation.sendKeys( ExcelUtils.getstringCellData(18, 4));
		}
	...
	public static void Address1FeildVliadation (WebDriver driver) throws Exception{
		...
		Address1FeildVliadation.sendKeys(ExcelUtils.getstringCellData(19, 4));
		
		
		 String ExpectedAddress1FeildVliadationErrorMessage = ExcelUtils.getstringCellData(19, 5);
		   	...
		   	Address1FeildVliadation.sendKeys(ExcelUtils.getstringCellData(20, 4));
	...
	//	WebElement City = driver.findElement(By.xpath(".//*[@id='BaseCustomer_City']"));
		CityFeildVliadation.sendKeys(ExcelUtils.getstringCellData(21, 4));
		CityFeildVliadation.sendKeys(Keys.TAB);
		Thread.sleep(2000);
		
		String ExpectedCityFeildVliadationErrorMessage = ExcelUtils.getstringCellData(21, 5);
		...
		if(ExpectedCityFeildVliadationErrorMessage.equals(CityFeildVliadation_ErrorMessage2))
		{
			...
			Thread.sleep(3000);
			CityFeildVliadation.sendKeys(ExcelUtils.getstringCellData(22, 4));
			CityFeildVliadation.sendKeys(Keys.TAB);
		}
		else{
		...
		String ExpectedCityFeildVliadation = ExcelUtils.getstringCellData(22, 5);
		...
		if(ExpectedCityFeildVliadation.equals(CityFeildVliadation_2))
		{
			...
			CityFeildVliadation.clear();
			Thread.sleep(4000);
			CityFeildVliadation.sendKeys(ExcelUtils.getstringCellData(23, 4));
		}
   ...
   */
	...
	public static  void ZipFeildVliadation (WebDriver driver) throws Exception{
		...
		Thread.sleep(3000);
		ZipFeildVliadation.sendKeys(String.valueOf(ExcelUtils.getintCellData(25, 4)));
		ZipFeildVliadation.sendKeys(Keys.TAB);
		Thread.sleep(3000);
		String ExpectedZipFeildVliadationErrorMessage = ExcelUtils.getstringCellData(25, 5);
		...
		if(ExpectedZipFeildVliadationErrorMessage.equals(ZipFeildVliadation_ErrorMessage))
		{
			...
			Thread.sleep(3000);
			ZipFeildVliadation.sendKeys(String.valueOf(ExcelUtils.getintCellData(26, 4)));
		}
		...
		else
		{
	        ...
	        String ExpectedZipFeildVliadationErrorMessage1 =  ExcelUtils.getstringCellData(26, 5);
			...
			if(ExpectedZipFeildVliadationErrorMessage1.equals(ZipFeildVliadation_ErrorMessage1))
			{
				...
				ZipFeildVliadation.clear();
				Thread.sleep(3000);
				ZipFeildVliadation.sendKeys(String.valueOf(ExcelUtils.getintCellData(27, 4)));
			}
			else{
