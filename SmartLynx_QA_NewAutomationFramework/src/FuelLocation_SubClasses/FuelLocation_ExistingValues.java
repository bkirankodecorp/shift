...
public class FuelLocation_ExistingValues {
	...
	public static  void Create_new (WebDriver driver) throws Exception{
		...
		driver.findElement(By.xpath(".//*[@id='BaseFuelingLocation_Code']")).sendKeys(ExcelUtils.getstringCellData(53, 4));
		 FuelLocation_ScreenShots.CaptureScreenshot(driver);
		 ExcelUtils.setCellData("pass",53, 7);
		 
		 driver.findElement(By.xpath(".//*[@id='BaseFuelingLocation_Text']")).sendKeys(ExcelUtils.getstringCellData(54, 4));
			FuelLocation_ScreenShots.CaptureScreenshot(driver);
			 ExcelUtils.setCellData("pass",54, 7);
				driver.findElement(By.xpath(".//*[@id='BaseFuelingLocation_Address1']")).sendKeys(ExcelUtils.getstringCellData(55, 4));
			FuelLocation_ScreenShots.CaptureScreenshot(driver);
			 ExcelUtils.setCellData("pass",55, 7);
			 
				driver.findElement(By.xpath(".//*[@id='BaseFuelingLocation_City']")).sendKeys(ExcelUtils.getstringCellData(56, 4));
			FuelLocation_ScreenShots.CaptureScreenshot(driver);
			...
			FuelLocation_ScreenShots.CaptureScreenshot(driver);
			 ...
			 FuelLocation_ScreenShots.CaptureScreenshot(driver);
		        ...
		        driver.findElements(By.xpath(".//span[@class='k-list-filter']/input")).get(ok_size-1).sendKeys(ExcelUtils.getstringCellData(57, 4));
		        ...
		        FuelLocation_ScreenShots.CaptureScreenshot(driver);
		       	...
		       	driver.findElement(By.xpath(".//*[@id='BaseFuelingLocation_Zip']")).sendKeys(String.valueOf(ExcelUtils.getintCellData(58, 4)));
		        FuelLocation_ScreenShots.CaptureScreenshot(driver);
		        ...
		        String ActualMessage = ExcelUtils.getstringCellData(63, 5);
