...
import Trailer_SubClasses.Trailer_Delete;
...
public class Trailer {
	 ...
	 public static void Execute(WebDriver driver) throws Exception{
		  ...
		  String Number	=ExcelUtils.getstringCellData(13, 4);
			String WareHouseidDropdownInput = ExcelUtils.getstringCellData(17, 4);
			int LoadedGrossWeight = ExcelUtils.getintCellData(18, 4);
			String Edit_Description = ExcelUtils.getstringCellData(45, 4);
			int Edit_LoadedGrossWeight = ExcelUtils.getintCellData(47, 4);
			
			int EditNumber = ExcelUtils.getintCellData(51, 4);
	    	 int EditCapacity = ExcelUtils.getintCellData(52, 4);
...
//	Trailer_EditScreen.EditSearch(driver).sendKeys(ExcelUtils.getstringCellData(101, 4));
	Thread.sleep(7000);
...
//	Trailer_EditScreen.Edit_Number(driver).click();
	...
	Thread.sleep(5000);
	Trailer_EditScreen. Edit_RegionMappingSearchbox(driver);
	Trailer_ScreenShots.CaptureScreenshot(driver);
