...
import Utility.ExcelUtils;
    ...
    public static void ExistingValues (WebDriver driver) throws Exception{
    	...
    	String Number	=ExcelUtils.getstringCellData(67, 4);
    	String Description =ExcelUtils.getstringCellData(68, 4);
    	String WareHouseidDropdownInput = ExcelUtils.getstringCellData(69, 4);
    	int LoadedGrossWeight = ExcelUtils.getintCellData(70, 4);
    	int CompartmentNumber = ExcelUtils.getintCellData(73, 4);
	 ...
	 String ActualErrorMessage = ExcelUtils.getstringCellData(79,5);
	...
	ExcelUtils.setCellData(UpdateMessage ,81, 6);
    	...
    	ExcelUtils.setCellData("Fail",81, 7);
