...
public class Trailer_UnDelete {
	 ...
	 public static void UnDelete(WebDriver driver) throws Exception{
	    	...
	    	String Number	=ExcelUtils.getstringCellData(84, 4);
	    	String Description =ExcelUtils.getstringCellData(85, 4);
	    	String WareHouseidDropdownInput = ExcelUtils.getstringCellData(86, 4);
	    	int LoadedGrossWeight = ExcelUtils.getintCellData(87, 4);
	    	int CompartmentNumber = ExcelUtils.getintCellData(90, 4);
	 
	    	String Search= ExcelUtils.getstringCellData(84, 4);
	...
	String UnDeleteActualMessage = ExcelUtils.getstringCellData(96, 5);
	 Trailer_ScreenShots.CaptureScreenshot(driver);
	 Thread.sleep(3000);
	 ...
	 if(UnDeleteMessage1.isDisplayed()){
		 ...
		 ExcelUtils.setCellData(UnDeleteMessage1.getText(),96, 6);
		 ExcelUtils.setCellData("pass",96, 7);
	 ...
	 Thread.sleep(3000);
		...
		if(Verify1.getText().isEmpty()){
			...
			System.out.println("Fail ");
			 ...
			 ExcelUtils.setCellData("Fail",100, 7);	
			
			
		}
		else
		{	System.out.println("Result found ");
		 ExcelUtils.setCellData("pass",100, 7);	
		}
