...
public class Trailer_EditScreen {
	...
	private static WebElement Edit_Capacity = null;
	 ...
	 public static WebElement  Edit_RegionMappingSearchbox(WebDriver driver) throws Exception{
			
		 Edit_RegionMappingSearchbox = driver.findElement(By.xpath("//*[@id='RegionTypeAhead']"));
		 
		 Edit_RegionMappingSearchbox.sendKeys(ExcelUtils.getstringCellData(54, 4));
