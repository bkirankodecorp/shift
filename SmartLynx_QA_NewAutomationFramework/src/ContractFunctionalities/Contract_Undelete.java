...
public class Contract_Undelete {
	public static  void UnDelete (WebDriver driver) throws Exception{
		...
		int Number =ExcelUtils.getintCellData(75, 4);
		...
		Contract_Screenshots.CaptureScreenshot(driver);
				     ...
				     Thread.sleep(8000);
				     Contract_Screenshots.CaptureScreenshot(driver);
				     String DropDownInput =ExcelUtils.getstringCellData(81, 4);
	...
	Contract_Screenshots.CaptureScreenshot(driver);
	 Thread.sleep(3000);
     String ActualMessage = ExcelUtils.getstringCellData(91, 5) ;
...
//	driver.findElement(By.xpath("//*[@id='BaseContract_IsRecordActive']")).click();
	 ...
	 driver.findElement(By.xpath(".//*[@id='txtSearchContractGrid']")).click();
	    ...
	    int Search =  ExcelUtils.getintCellData(75, 4);
		...
		if(Verify1.getText().isEmpty()){
			...
			int Number4 =ExcelUtils.getintCellData(75, 4);
			...
			Contract_Screenshots.CaptureScreenshot(driver);
					 Contract_Screenshots.CaptureScreenshot(driver);
					     ...
					     Thread.sleep(3000);
					     Contract_Screenshots.CaptureScreenshot(driver);
					     String DropDownInput1 =ExcelUtils.getstringCellData(81, 4);
		...
		driver.findElement(By.xpath("//*[@id='BaseContract_IsRecordActive']")).click();
		 ...
		 Thread.sleep(6000);
		    ...
		    int Search1 =  ExcelUtils.getintCellData(75, 4);
