...
public class Contract {
	...
	int Search = ExcelUtils.getintCellData(8, 4);
	int Number =ExcelUtils.getintCellData(19, 4);
	int Pin =ExcelUtils.getintCellData(31, 4);
	String Terminal = ExcelUtils.getstringCellData(25, 4);
	String ProductDetailsSearchBox = ExcelUtils.getstringCellData(33, 4);
