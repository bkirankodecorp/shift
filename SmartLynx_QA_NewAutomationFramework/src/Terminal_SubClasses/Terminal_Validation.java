...
public class Terminal_Validation {
	...
	Actions action2 = new Actions(driver);
	  ...
	  action2.moveToElement(driver.findElements(By.xpath(".//*[@id='MainMenu']/li[2]/div/ul/li[11]/a")).get(ok_size1-1)).click();

	  Thread.sleep(5000);
	  Terminal_ScreenShots.CaptureScreenshot(driver);

	  driver.findElement(By.xpath(".//*[@id='MainMenu']/li[2]/div/ul/li[11]/a")).click();
 ...
 public static WebElement ErrorMessage(WebDriver driver) throws Exception{
	 ...
	 driver.findElement(By.xpath(".//*[@id='form0']/div/div/div/div/div/div/div[1]/div/div[2]/button")).click();	 
	    ...
	    String ExpectedNumberErrorMessage = ExcelUtils.getstringCellData(11, 5);
		...
		String ExpectedNameErrorMessage =  ExcelUtils.getstringCellData(12, 5);
		...
		String ExpectedAverageloadtimeErrorMessage =  ExcelUtils.getstringCellData(13, 5);
		...
		String ExpectedAddressErrorMessage =  ExcelUtils.getstringCellData(14, 5);
		...
		String ExpectedCityErrorMessage =  ExcelUtils.getstringCellData(15, 5);
		...
		String ExpectedStateErrorMessage =  ExcelUtils.getstringCellData(16, 5);
		...
		String ExpectedZipErrorMessage = ExcelUtils.getstringCellData(17, 5);
 ...
 public static WebElement  Name (WebDriver driver) throws Exception{
	...
	Name.sendKeys(ExcelUtils.getstringCellData(22, 4));
	Thread.sleep(3000);
	Name.sendKeys(Keys.TAB);
	String ExpectedNameErrorMessage = ExcelUtils.getstringCellData(23, 5);
	String ActualNameErrorMessage = driver.findElement(By.xpath(".//*[@id='BaseTerminal_NameCode-error']")).getText();
	...
	{
		Name.clear();
		Name.sendKeys(ExcelUtils.getstringCellData(24, 4));
...
WebElement Address = driver.findElement(By.xpath(".//*[@id='TerminalAddress_Address']"));
	 ...
	 Address.sendKeys(ExcelUtils.getstringCellData(26,4));
	 String ExpectedAddressErrorMessage = ExcelUtils.getstringCellData(26,5);
	   	String	ActualAddressErrorMessage = driver.findElement(By.xpath(".//*[@id='TerminalAddress_Address-error']")).getText();
 ...
 public static WebElement  City (WebDriver driver) throws Exception{
	 ...
	 City.sendKeys(ExcelUtils.getstringCellData(27,4));
	 
	 String ExpectedCityErrorMessage = ExcelUtils.getstringCellData(27,6);
	   	String	ActualCityErrorMessage = driver.findElement(By.xpath(".//*[@id='TerminalAddress_City-error']")).getText();
	   	...
	   	City.clear();
	   	City.sendKeys(ExcelUtils.getstringCellData(28,4));
 ...
 public static void Zip (WebDriver driver) throws Exception{
	 ...
	 WebElement Zip = driver.findElement(By.xpath(".//*[@id='TerminalAddress_Zip']"));
		Zip.sendKeys(String.valueOf(ExcelUtils.getintCellData(30, 4)));
		Zip.sendKeys(Keys.TAB);
		Thread.sleep(3000);
		String ExpectedZipErrorMessage = ExcelUtils.getstringCellData(30, 5);
		...
		{
			Zip.clear();
			Zip.sendKeys(String.valueOf(ExcelUtils.getintCellData(31, 4)));
			Thread.sleep(3000);
		
			
			
			String ExpectedZipErrorMessage1 = ExcelUtils.getstringCellData(31, 5);
			...
			if(ZipErrorMessage1.isDisplayed()){
				...
				Zip.clear();
				Zip.sendKeys(String.valueOf(ExcelUtils.getintCellData(32, 4)));
 ...
 public static WebElement   Latitude (WebDriver driver) throws Exception{
	  ...
	  Latitude.sendKeys(String.valueOf(ExcelUtils.getdoubleCellData(33, 4)));
 ...
 public static WebElement   Longitude (WebDriver driver) throws Exception{
	 ...
	 Longitude.sendKeys(String.valueOf(ExcelUtils.getdoubleCellData(35, 4)));
...
public static WebElement   SupplierMappingSearchbox (WebDriver driver)throws Exception{
	...
	SupplierMappingSearchbox  = driver.findElement(By.xpath("//*[@id='SupplierTypeAhead']"));
...
public static WebElement   DriverMappingSearchbox (WebDriver driver)throws Exception{
	...
	DriverMappingSearchbox  = driver.findElement(By.xpath("//*[@id='DriverTypeAhead']"));
...
public static WebElement  TruckMappingSerachBox (WebDriver driver)throws Exception{
	...
	TruckMappingSerachBox  = driver.findElement(By.xpath("//*[@id='TruckTypeAhead']"));
