...
public class Terminal {
	...
	LogIn_page.txtbx_UserName(driver).sendKeys(ExcelUtils.getstringCellData(3,4 ));
	ExcelUtils.setCellData("Pass", 3, 7);
	// Password in Login Page

	Terminal_ScreenShots.CaptureScreenshot(driver);

	LogIn_page.txtbx_Password(driver).sendKeys(ExcelUtils.getstringCellData(4,4 )); 
	...
	Terminal_Validation.Serachbox(driver).sendKeys(ExcelUtils.getstringCellData(7,4 ));
...
/*
	...
	// clicking on create new button
	   ...
	   // Error message validation
		...
		Terminal_Validation.Number(driver).sendKeys(String.valueOf(ExcelUtils.getstringCellData(21,4 )));
		Thread.sleep(2000);
		Terminal_ScreenShots.CaptureScreenshot(driver);
	// Name field validation 	
		...
		// enter the number AvrageLoadTime 
		  ...
		  Terminal_Validation.AvrageLoadTime(driver).sendKeys(String.valueOf(ExcelUtils.getintCellData(25,4)));
	      Thread.sleep(1000);
...
//		String City = sheet.getRow(1).getCell(6).getStringCellValue();
		...
		Terminal_Validation.StateInput(driver).sendKeys(ExcelUtils.getstringCellData(29,4));
		Thread.sleep(2000);
		Terminal_ScreenShots.CaptureScreenshot(driver);
	 ...
	 //8    
		...
		Terminal_Validation.SupplierMappingSearchbox(driver).sendKeys(ExcelUtils.getstringCellData(38,4));
		Terminal_ScreenShots.CaptureScreenshot(driver);
		Thread.sleep(4000);
		...
		Terminal_Validation.DriverMappingSearchbox(driver).sendKeys(ExcelUtils.getstringCellData(41,4 ));
		Thread.sleep(4000);
		...
		// clicking on the truckmapping checkbox
				Terminal_Validation.TruckMappingSerachBox(driver).sendKeys(ExcelUtils.getstringCellData(44,4 ));
		Thread.sleep(2000);
	...
	//  Terminal_EditScreen.EditName(driver).sendKeys(ExcelUtils.getstringCellData(50,4));
	  Thread.sleep(2000);
	  ...
	  Terminal_EditScreen.EditAvrageLoadTime(driver).sendKeys(String.valueOf(ExcelUtils.getintCellData(51,4)));
	  ...
	  Terminal_EditScreen.EditAddress(driver).sendKeys(ExcelUtils.getstringCellData(52,4));
	  ...
	  Terminal_ScreenShots.CaptureScreenshot(driver);
	  Terminal_EditScreen.EditCity(driver).sendKeys(ExcelUtils.getstringCellData(53,4));
	  ...
	  Terminal_EditScreen.EditZip(driver).sendKeys(String.valueOf(ExcelUtils.getintCellData(55, 4)));
	  Thread.sleep(2000);
	  Terminal_ScreenShots.CaptureScreenshot(driver);
	// editing the latitude field
	  ...
	  Terminal_EditScreen.EditLatitude(driver).sendKeys(String.valueOf(ExcelUtils.getintCellData(56, 4)));
	  Thread.sleep(2000);
	  Terminal_ScreenShots.CaptureScreenshot(driver);
	// editing the longitude field
	  ...
	  Terminal_EditScreen.EditLongitude(driver).sendKeys(String.valueOf(ExcelUtils.getintCellData(57, 4)));
