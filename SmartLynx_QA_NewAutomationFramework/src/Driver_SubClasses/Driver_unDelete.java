...
public class Driver_unDelete {
	...
	public static  void UnDelete (WebDriver driver) throws Exception{
		...
		String Driver_Name =  ExcelUtils.getstringCellData(70, 4);
		 ...
		 Thread.sleep(5000);
		 int Driver_HomePhone = ExcelUtils.getintCellData(73, 4);
		 ...
		 int Driver_CellPhone = ExcelUtils.getintCellData(74, 4);
		 ...
		 Driver_ScreenShots.CaptureScreenshot(driver);
		 int CostPerHour = ExcelUtils.getintCellData(75, 4);
		 ...
		 Driver_ScreenShots.CaptureScreenshot(driver);
		 String Email = ExcelUtils.getstringCellData(76, 4);
	...
	TerminalMapping_Tab.click();
	 ...
	 Driver_ScreenShots.CaptureScreenshot(driver);
	 WebElement TerminalMapping_Access = driver.findElement(By.xpath("//span[@class='k-checkbox']//input[@value='15']"));
	 ...
	 String UnDeleteMessageError =  ExcelUtils.getstringCellData(84, 5);
...
String Search = ExcelUtils.getstringCellData(70, 4);
...
TerminalMapping_Tab1.click();
 ...
 ExcelUtils.setCellData("Pass",78, 7);
 Driver_ScreenShots.CaptureScreenshot(driver);
 WebElement TerminalMapping_Access1 = driver.findElement(By.xpath("//span[@class='k-checkbox']//input[@value='15']"));
...
String Search1 = ExcelUtils.getstringCellData(70, 4);
