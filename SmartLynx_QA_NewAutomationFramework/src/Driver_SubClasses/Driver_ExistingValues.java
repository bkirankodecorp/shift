...
public class Driver_ExistingValues {
	...
	public static  void ExistingValues (WebDriver driver) throws Exception{
		...
		String Driver_Name =  ExcelUtils.getstringCellData(50, 4);
		 ...
		 Driver_ScreenShots.CaptureScreenshot(driver);
		 Thread.sleep(5000);
		 int Driver_HomePhone = ExcelUtils.getintCellData(52, 4);
		 ...
		 int Driver_CellPhone = ExcelUtils.getintCellData(53, 4);
		 ...
		 Thread.sleep(5000);
		 Driver_ScreenShots.CaptureScreenshot(driver);
		 int CostPerHour = ExcelUtils.getintCellData(54, 4);
		 ...
		 Thread.sleep(5000);
		 Driver_ScreenShots.CaptureScreenshot(driver);
		 String Email = ExcelUtils.getstringCellData(55, 4);
		...
		String ActualMessage = ExcelUtils.getstringCellData(64,5 );
		 Thread.sleep(5000);
