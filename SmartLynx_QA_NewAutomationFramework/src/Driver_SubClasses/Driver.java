...
public class Driver {
	 ...
	 public static void Execute(WebDriver driver) throws Exception{
			...
			String sUserName = ExcelUtils.getstringCellData(3, 4);
       	String sPassword = ExcelUtils.getstringCellData(4, 4);
		    String Search = ExcelUtils.getstringCellData(7, 4);
		    String Driver_Id = ExcelUtils.getstringCellData(13, 4);
		  
		    

		  int Driver_PhoneNumber = ExcelUtils.getintCellData(17, 4);
		  int Driver_MobileNumber = ExcelUtils.getintCellData(18, 4);
		  int Driver_Cost =ExcelUtils.getintCellData(19, 5);
		  String EditDriver_Name = ExcelUtils.getstringCellData(33, 4);
		  int   EditDriver_HomePhone1 = ExcelUtils.getintCellData(34, 4);
		  int Driver_MobileNumber1 = ExcelUtils.getintCellData(35, 4);
		  int  EditDriver_Cost1 = ExcelUtils.getintCellData(36, 4);
		  String EditDriver_Email1 =ExcelUtils.getstringCellData(37, 4);
		
		 String Serach1=    ExcelUtils.getstringCellData(43, 4);
		...
		//Terminal Mapping Tab
		 ...
		 //Delete POPUP
			...
			// Driver_Delete.Driverconfirmationok(driver).click();
			 Driver_Delete.Driverconfirmationcancel(driver);
			 Thread.sleep(3000);
			 ...
			 Driver_Delete.Delete(driver).click();
			 Thread.sleep(3000);
			 Driver_Delete.Driverconfirmationok(driver);
			 Thread.sleep(3000);
			 ...
			 Thread.sleep(5000);
			 Driver_unDelete.UnDelete(driver);
			 Driver_ScreenShots.CaptureScreenshot(driver);
